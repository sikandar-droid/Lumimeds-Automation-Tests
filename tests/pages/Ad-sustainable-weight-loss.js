/**
 * Page Object Model for LumiMeds Ad Page - sustainable-weight-loss
 * Standard page with Get Started buttons only
 */
...
class AdPage {
    constructor(page) {
        ...
        this.heroDescription = page.locator('text=/Losing weight does not have to be|personalized treatment/i');
        ...
        this.valueSection = page.locator('text=/Value/i').first();
