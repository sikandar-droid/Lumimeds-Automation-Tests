/**
 * Page Object Model for LumiMeds Ad Page - glp1-gip-treatment
...
class AdPage {
    constructor(page) {
        ...
        this.heroDescription = page.locator('text=/Compounded Tirzepatide|GLP-1/i');
        ...
        // Trustpilot Section
        this.customerReviewsHeading = page.locator('text=/Customer Reviews/i');
