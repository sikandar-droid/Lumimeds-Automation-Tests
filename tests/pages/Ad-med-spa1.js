...
class AdPage {
    constructor(page) {
        ...
        // Additional CTA Buttons (med-spa1 specific)
    ...
    async goto(pageName, options = {}) {
        ...
        // med-spa1 uses /en/ad/ path
        await this.page.goto(`https://lumimeds.com/en/ad/${pageName}`, defaultOptions);
    }
    ...
    /**
     * Get all Get Started buttons on the page (including "Choose Your Plan Now")
     */
    async getAllGetStartedButtons() {
        ...
        return [...buttons, ...links, ...chooseButtons, ...chooseLinks];
    }

    /**
     * Click the primary CTA button (Get Started or Choose Your Plan Now)
     */
    async clickPrimaryGetStarted() {
        // Try "Choose Your Plan Now" button first (for med-spa pages)
        try {
